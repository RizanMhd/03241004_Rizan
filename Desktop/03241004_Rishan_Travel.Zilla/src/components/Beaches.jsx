  ...
  return (
    <div className="place-category">
      <div className="category-header">
        <h1>🏖️ Sri Lanka's Beaches</h1>
        <p>Discover the pristine beaches and coastal treasures of Sri Lanka</p>
      </div>

      <div className="places-grid">
        {beaches.map((beach) => (
          <div key={beach.id} className="place-card" onClick={() => setSelectedPlace(beach)}>
            <div className="place-image" style={{backgroundImage: `url("${encodeURI(beach.image)}")`}}>
            ...
            <div className="place-info">
              <h3>{beach.name}</h3>
              <p className="location">📍 {beach.location}</p>
              <p className="distance">🚗 {beach.distanceFromColombo}</p>
            </div>
          </div>
        ))}
      </div>
            ...
            <div className="place-detail">
              ...
              <div className="detail-info">
                ...
                <div className="info-row">
                  ...
                  <span className="value">{selectedPlace.waterTemperature}</span>
                </div>
                <div className="info-row">
