...
import { campingSites } from '../data/places';
  ...
  return (
    <div className="place-category">
      <div className="category-header">
        <h1>🏕️ Sri Lanka's Camping Sites</h1>
        <p>Experience the best camping and outdoor accommodations in Sri Lanka</p>
      </div>

      <div className="places-grid">
        {campingSites.map((site) => (
          <div key={site.id} className="place-card" onClick={() => setSelectedPlace(site)}>
            <div className="place-image" style={{backgroundImage: `url("${encodeURI(site.image)}")`}}>
            ...
            <div className="place-info">
              ...
              <p className="distance">🚗 {site.distanceFromColombo}</p>
              <p className="altitude">📏 {site.altitude}</p>
            </div>
          </div>
        ))}
      </div>
            ...
            <div className="place-detail">
              ...
              <div className="detail-info">
                ...
                <div className="info-row">
                  ...
                  <span className="value">{selectedPlace.accommodationType}</span>
                </div>
                <div className="info-row">
                  <span className="label">🏗️ Facilities:</span>
                  <span className="value">{selectedPlace.facilities}</span>
                </div>
                <div className="info-row">
                ...
                <div className="info-row">
                  ...
                  <span className="value">{selectedPlace.pricePerNight}</span>
                </div>
              </div>
